...
export const homepageDefaults: HomepageContent = {
  ...
  hero: {
    ...
    subcopy:
      "We install a client acquisition infrastructure that generates qualified sales conversations consistently â€” so you stop relying on content, referrals, or luck.",
  ...
  features: {
    ...
    subcopy:
      "Three core capabilities working together to turn cold prospects into booked sales calls â€” consistently, every month.",
    cards: [
      {
        icon: "search",
        title: "Precision Prospect Identification",
        copy: "We identify men actively seeking transformation and growth â€” the exact people your coaching programme is built for. No guesswork. No wasted outreach.",
      },
      {
        icon: "chat",
        title: "Real Conversations. Not Spam.",
        copy: "Our team starts genuine, personalised conversations on your behalf across Instagram, LinkedIn, and email â€” building trust before a single sales call happens.",
      },
      {
        icon: "pulse",
  ...
  workflow: {
    ...
    steps: [
      ...
      },
      {
        ...
        copy: "We build a hyper-targeted list of coaches' ideal clients using behavioural and interest signals â€” men who are actively searching for the transformation you provide. Quality over volume at every stage.",
      },
      {
        title: "Strategic multi-channel outreach",
        copy: "Our team executes personalised outreach campaigns across Instagram, LinkedIn, and email â€” starting real conversations that feel human, not automated. We handle every reply, every objection, every follow-up.",
      },
      {
        title: "Qualified call delivery to your calendar",
        copy: "Prospects are qualified, pre-framed, and booked directly onto your calendar. You show up to calls with men who already understand your offer and are ready to invest â€” not cold strangers.",
      },
      {
  ...
  pricing: {
    ...
    note: "Not sure which tier is right? Apply anyway â€” we'll recommend the right fit after reviewing your business.",
    bulletIcon: "check_circle",
    tiers: [
      {
        badge: "Founding Partner",
        name: "Starter",
        tagline: "For coaches building their first consistent lead flow. Founding rate â€” 3 spots only.",
        price: "$600",
        priceWas: "$900",
        priceSuffix: "per month Â· founding rate",
        bullets: [
  ...
  application: {
    ...
    promiseItems: [
      ...
      { title: "Honest fit assessment", body: "If we can't help you, we'll tell you directly â€” and explain why." },
    ...
    fields: {
      ...
      bottleneckPlaceholder: "Be honest â€” the more specific you are, the better we can assess fit.",
      revenueOptions: [
        { value: "Under $3k/mo", label: "Under $3k/mo" },
        { value: "$3k â€“ $8k/mo", label: "$3k â€“ $8k/mo" },
        { value: "$8k â€“ $20k/mo", label: "$8k â€“ $20k/mo" },
        { value: "$20k â€“ $50k/mo", label: "$20k â€“ $50k/mo" },
    ...
    successBody:
      "Hamza reviews every application personally. You'll hear back within 48 hours â€” check your inbox, including spam.",
  ...
  footer: {
    ...
    copyright: "Â© 2026 Shaditz. All rights reserved.",
  },
};
