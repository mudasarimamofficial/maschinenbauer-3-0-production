      ...
      <div className="rounded-2xl border border-white/10 bg-[var(--cf-surface-container)] p-4">
        ...
        <div className="mt-3 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <Input
            ...
            placeholder="Datenschutz oder Impressum fuer Maschinenbauer 3.0."
          />
        </div>
        <div className="mt-4 rounded-2xl border border-white/10 bg-[var(--cf-surface-low)] px-4 py-3">
          ...
          <div className="mt-2">
            ...
            <div className="mt-1 truncate text-xs text-white/50">https://maschinenbauer-3-0-production.vercel.app/p/{slug || "your-slug"}</div>
