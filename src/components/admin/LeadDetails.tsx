      ...
      {lead ? (
        <div className="flex flex-col gap-4 text-sm">
          ...
          <div>
            ...
            <div className="mt-1 font-semibold">{lead.phone || "â€”"}</div>
          </div>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <div className="mt-1 font-semibold">{lead.business_type || "â€”"}</div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">
                Revenue
              </div>
              <div className="mt-1 font-semibold">{lead.revenue || "â€”"}</div>
            </div>
          </div>
          <div>
            <div className="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">
